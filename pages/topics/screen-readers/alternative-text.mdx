...
<div className="grid grid-cols-2 items-center justify-center text-lg">
    ```html
    <img
        src="the-big-one.jpg"
...
Icons and emojis are definitely types of graphical content that need text alternatives. There are specific requirements depending on how the icons are used: within links or buttons, within bodies of text, or if they're decorative. More info from Suzanne Aitchison: https://www.upyoura11y.com/images-icons-and-emojis/
